    ...
    <footer className="bg-gray-100 text-center py-8">
      ...
      {!token && (
        <div className="mb-6">
          ...
          <p>
            Join DEW today and start planning your unforgettable experiences.
          </p>
          <Link to={"/register"}>
            <button className="bg-gray-700 text-white font-bold py-3 px-6 mt-6 rounded-lg shadow-md hover:bg-gray-600 mb-10">
              Sign Up Now
            </button>
          </Link>
        </div>
