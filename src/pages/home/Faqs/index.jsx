...
const FAQs = () => {
  ...
  const faqs = [
    ...
    {
      question:
        "What makes Detroit Epic Weekend different from other travel planning services?",
      answer:
    ...
    {
      question:
        "Can Detroit Epic Weekend accommodate special requests or occasions?",
      answer:
    ...
    {
      question:
        "Can I get real-time updates and suggestions during my weekend?",
      answer:
